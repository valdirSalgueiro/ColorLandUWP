...
namespace ColorLand
{
    public class HUD
    {
        ...
        private Rect mRectPlayerBarEnergy;
        private Rect mRectPlayerBar;
        private Rect mRectBarEnergy;
        private Rect mRectBar;

        //location das cores
        private Rect mRectColorSlot1;
        private Rect mRectColorSlot2;
        private Rect mRectColorSlot3;
        ...
        private HUD()
        {
            mRectHead = new Rect(20,
                                           10,
                                           100,
                                           100);

            mRectPlayerBarEnergy = new Rect(128,
                                        566,
                                        181,
                                        23);

            mRectPlayerBar = new Rect(128,
                            564,
                            181,
                            27);

            mRectBarEnergy = new Rect(315,
                            566,
                            0,
                            23);

            mRectBar = new Rect(315,
                            564,
                            182,
                            27);


            mRectColorSlot1 = new Rect(574, 535, 70, 70);
            mRectColorSlot2 = new Rect(634, 512, 70, 70);
            mRectColorSlot3 = new Rect(695, 535, 70, 66);
            
            /*mRectColorSlot1 = new Rect(574 - 260, 535, 70, 70);
            mRectColorSlot2 = new Rect(634 - 260, 512, 70, 70);
            mRectColorSlot3 = new Rect(695 - 260, 535, 70, 66);
            */
        ...
        public void draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(mTextureHudBG, new Rect(550 + complement /*- 260*/, Game1.sSCREEN_RESOLUTION_HEIGHT - 96, 238, 96), Color.White);
            spriteBatch.Draw(mTextureHudBGHead, new Rect(42 + complement, 38, 285, 64), Color.White);

            if (energy > 0)
            {
                spriteBatch.Draw(mBarraBLeft, new Rect(115 + complement, 38 + 15, 7, 20), Color.White);
                spriteBatch.Draw(mBarraBMiddle, new Rect(115 + 7 + complement, 38 + 15, (int)(energy * 185), 20), Color.White);
                spriteBatch.Draw(mBarraBRight, new Rect(114 + 7 + (int)(energy * 185) + complement, 38 + 15, 7, 20), Color.White);
            }

            if (level > 0)
            {
                spriteBatch.Draw(mBarraOLeft, new Rect(114 + complement, 60 + 19, 7, 8), Color.White);
                spriteBatch.Draw(mBarraOMiddle, new Rect(114 + 7 + complement, 60 + 19, (int)(level * 147), 8), Color.White);
                spriteBatch.Draw(mBarraORight, new Rect(114 + 7 + (int)(level * 147) + complement, 60 + 19, 7, 8), Color.White);
            }
            mGroupButtons.draw(spriteBatch);

            mRectHead = new Rect(20 + complement, mRectHead.Y, mRectHead.Width, mRectHead.Height);
