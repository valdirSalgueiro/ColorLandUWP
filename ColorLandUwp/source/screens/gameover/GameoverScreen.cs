...
namespace ColorLand
{
    class GameoverScreen : BaseScreen
    {
        ...
        public GameoverScreen()
        {
            ...
            mButtonYes = new Button("gameplay\\pausescreen\\continue", "gameplay\\pausescreen\\continue_select", "gameplay\\pausescreen\\continue_selected", new Rect(400 - 319 / 2, 300 - 117/2 - 50, 319, 117));
            mButtonNo = new Button("gameplay\\pausescreen\\exit", "gameplay\\pausescreen\\exit_select", "gameplay\\pausescreen\\exit_selected", new Rect(400 - 290 / 2, 300 - 115 / 2 + 80, 290, 115));
        ...
        public override void draw(GameTime gameTime)
        {
            ...
            mSpriteBatch.Draw(mGameoverBackgroundTexture, new Rect(0, 0, 800, 600), new Color(0, 0, 0, 0.5f));

            //mSpriteBatch.Draw(mGameoverTitleTexture, new Rect(150, 0, 577, 222), Color.White);
