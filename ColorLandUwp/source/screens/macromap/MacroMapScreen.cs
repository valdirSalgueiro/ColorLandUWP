...
namespace ColorLand
{
    public class MacroMapScreen : BaseScreen
    {
        ...
        private Rect mRectangleExhibitionTexture;
        ...
        public MacroMapScreen()
        {
            ...
            mRectangleExhibitionTexture = new Rect(0, 0, 800, 600);
        ...
        public override void draw(GameTime gameTime)
        {
            ...
            mSpriteBatch.Draw(mTextureBorder, new Rect(0, 0, 800, 600), Color.White);
            mSpriteBatch.Draw(mTextureBussola, new Rect(800-168, 422, 158, 165), Color.White);
            ...
            mSpriteBatch.Draw(mTexturePinoBussola, new Rect(632, 425, 158, 165), Color.White);
            ...
            {
                mSpriteBatch.Draw(mTexturePlayerFalling, new Vector2(176, 235), new Rect(0, 0, mTexturePlayerFalling.Width, mTexturePlayerFalling.Height), Color.White, 0f, new Vector2(30, 30), reduceScale(), SpriteEffects.None, 0);
            }
