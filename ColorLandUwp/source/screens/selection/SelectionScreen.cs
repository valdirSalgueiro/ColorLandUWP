...
namespace ColorLand
{
    public class SelectionScreen : BaseScreen
    {
        ...
        public SelectionScreen()
        {
            ...
            mRect1 = new Rect(102, 223,150, 155);
            mRect2 = new Rect(327, 223, 150, 155);
            mRect3 = new Rect(565, 223, 150, 155);
        ...
        public override void draw(GameTime gameTime)
        {
            ...
            mSpriteBatch.Draw(mTextureChooseTitle, new Rect(188, 50, mTextureChooseTitle.Width, mTextureChooseTitle.Height), Color.White);

            /*if (mCurrentSelectableCharacter == mSelectableCharacterRed)
            {
                mSpriteBatch.Draw(mTextureRedNameSelected, new Rect(120, 430, mTextureRedNameSelected.Width, mTextureRedNameSelected.Height), Color.White * mAlpha);
                mSpriteBatch.Draw(mTextureGreenNameUnselected, new Rect(354, 435, mTextureGreenNameUnselected.Width, mTextureGreenNameUnselected.Height), Color.White * mAlpha);
                mSpriteBatch.Draw(mTextureBlueNameUnselected, new Rect(580, 430, mTextureBlueNameUnselected.Width, mTextureBlueNameUnselected.Height), Color.White * mAlpha);
            }
            else
            if (mCurrentSelectableCharacter == mSelectableCharacterGreen)
            {
                mSpriteBatch.Draw(mTextureGreenNameSelected, new Rect(354, 435, mTextureGreenNameSelected.Width, mTextureGreenNameSelected.Height), Color.White * mAlpha);
                mSpriteBatch.Draw(mTextureRedNameUnselected, new Rect(120, 430, mTextureRedNameUnselected.Width, mTextureRedNameUnselected.Height), Color.White * mAlpha);
                mSpriteBatch.Draw(mTextureBlueNameUnselected, new Rect(580, 430, mTextureBlueNameUnselected.Width, mTextureBlueNameUnselected.Height), Color.White * mAlpha);
            }
            else
            if (mCurrentSelectableCharacter == mSelectableCharacterBlue)
            {
                mSpriteBatch.Draw(mTextureBlueNameSelected, new Rect(580, 430, mTextureBlueNameSelected.Width, mTextureBlueNameSelected.Height), Color.White * mAlpha);
                mSpriteBatch.Draw(mTextureGreenNameUnselected, new Rect(354, 435, mTextureGreenNameUnselected.Width, mTextureGreenNameUnselected.Height), Color.White * mAlpha);
                mSpriteBatch.Draw(mTextureRedNameUnselected, new Rect(120, 430, mTextureRedNameUnselected.Width, mTextureRedNameUnselected.Height), Color.White * mAlpha);
            }
            else //ninguem selecionado
            {
                mSpriteBatch.Draw(mTextureBlueNameUnselected, new Rect(580, 430, mTextureBlueNameUnselected.Width, mTextureBlueNameUnselected.Height), Color.White);
                mSpriteBatch.Draw(mTextureGreenNameUnselected, new Rect(354, 435, mTextureGreenNameUnselected.Width, mTextureGreenNameUnselected.Height), Color.White);
                mSpriteBatch.Draw(mTextureRedNameUnselected, new Rect(120, 430, mTextureRedNameUnselected.Width, mTextureRedNameUnselected.Height), Color.White);
            }
            */
