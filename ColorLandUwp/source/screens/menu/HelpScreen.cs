...
namespace ColorLand
{
    class HelpScreen : BaseScreen
    {
        ...
        private void init()
        {
            ...
            mButtonBack = new Button("mainmenu\\help\\Menu_back", "mainmenu\\help\\Menu_back_select", "mainmenu\\help\\Menu_back_selected", new Rect(45, 450, 178, 128));
            mButtonPrevious = new Button("mainmenu\\help\\previous", "mainmenu\\help\\previous_select", "mainmenu\\help\\previous_selected", new Rect(350, 474, 80, 86));
            mButtonNext = new Button("mainmenu\\help\\next", "mainmenu\\help\\next_select", "mainmenu\\help\\next_selected", new Rect(586, 474, 80, 86));
        ...
        public override void draw(GameTime gameTime)
        {
            ...
            {
                mSpriteBatch.Draw(mNext, new Rect(586, 474, 80, 86), Color.White);
            }
            if (currentScreen == 0)
            {
                mSpriteBatch.Draw(mPrevious, new Rect(350, 474, 80, 86), Color.White);
            }
