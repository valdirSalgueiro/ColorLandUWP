...
namespace ColorLand
{
    class CreditsScreen : BaseScreen
    {
        ...
        public CreditsScreen(MainMenuScreen owner_)
        {
            ...
            mButtonBack = new Button("mainmenu\\buttons\\menu_credits_help_back", "mainmenu\\buttons\\menu_credits_help_back_select", "mainmenu\\buttons\\menu_credits_help_back_selected", new Rect(50, 464, 175, 124));
