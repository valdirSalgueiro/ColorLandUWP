...
namespace ColorLand
{
    public abstract class GameObject
    {
        ...
        private Rect mAttackCollisionRect;
        ...
        public virtual void draw(SpriteBatch spriteBatch, float rotationAngle, Rect rotationPosition, Vector2 origin)
        {
            if (mIsActive)
            {
                if (mIsVisible)
        ...
        public virtual void draw(SpriteBatch spriteBatch, float rotationAngle, Rect rotationPosition, Vector2 origin, Color color)
        {
            if (mIsActive)
            {
                if (mIsVisible)
        ...
        public bool collidesWith(Rect rectangle)
        {
            if (mCollisionEnabled)
            {
        ...
        {
            mAttackCollisionRect = new Rect(x, y, width, height);
            mInitialAttackCollisionRectX = x;
            mInitialAttackCollisionRectY = y;
        }

        public void setAttackRectangle(Rect r)
        {
            mAttackCollisionRect = r;
        }

        public Rect getAttackRectangle()
        {
