...
namespace ColorLand
{
	public class Button : GameObject
	{
        ...
        public Button(String imgNormal, String imgPressed, Rect rectArea)
        {
            mSpriteNormal = new Sprite(ExtraFunctions.fillArrayWithImages(1,imgNormal), new int[] { 0 }, 7, (int)rectArea.Width, (int)rectArea.Height, false, false);
            mSpritePressed = new Sprite(ExtraFunctions.fillArrayWithImages(1, imgPressed), new int[] { 0 }, 7, (int)rectArea.Width, (int)rectArea.Height, false, false);
            ...
            setCollisionRect(0, 0, (int)rectArea.Width, (int)rectArea.Height);
        ...
        public Button(String imgNormal, String imgHighlight, String imgPressed, Rect rectArea)
        {
