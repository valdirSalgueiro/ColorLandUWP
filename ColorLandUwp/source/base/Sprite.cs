...
namespace ColorLand
{
    ...
    public class Sprite
    {
        ...
        //TODO melhorar
        public void draw(SpriteBatch spritebatch, double angle, Rect rotationPosition, Vector2 origin)
        {
            if (mVisible)
            {
                //se der um caralho aqui foi culpa da cor, digo logo. Volta pra Color.WHITE
        ...
        //praticamente copia do draw anterior
        //TODO melhorar
        public void draw(SpriteBatch spritebatch, double angle, Rect rotationPosition, Vector2 origin, Color color)
        {
            if (mVisible)
            {
                //se der um caralho aqui foi culpa da cor, digo logo. Volta pra Color.WHITE
        ...
        public void draw(SpriteBatch spritebatch, double angle, Vector2 rotationPosition, Vector2 rotationOrigin)
        {
            if (mVisible)
            {
                ...
                else
                {
                    ...
                    spritebatch.Draw(mImage, rotationPosition, new Rect(0, 0, 259, 247), new Color(R, G, B), (float)angle, rotationOrigin, 1, flipEffect, 1);
                }
            }
        ...
        {
            return new Rect((int)mX + (int)offset.X, (int)mY + (int)offset.Y, mWidth, mHeight);
        }

        public Rect srcRectangle()
        {
            return new Rect(this.mSourceX, this.mSourceY, mSourceWidth, mSourceHeight);
        }
