...
namespace ColorLand
{
	public class OptionComponent
	{
        ...
        public OptionComponent(OptionType type, Vector2 location)
        {
            ...
            mButtonArrowLeft = new Button("test\\0009", "e1", new Rect((int)location.X, (int)location.Y, 40, 40));
            mButtonArrowRight = new Button("eblue", "egreen", new Rect((int)location.X + 100, (int)location.Y, 40, 40));            
